  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
        ...
        <p className='text-sm text-center mb-6'>{state === 'Sign Up' ? 'Create your account' : 'Login to your acount'}</p>
        <form>
          ...
          <input className='bg-transparent outline-none' type="password" placeholder='Enter Password' required />
          </div>

          <p className='mb-4 text-indigo-500 cursor-pointer'>Forgot Password?</p>
          <button className='w-full py-2.5 rounded-full bg-gradient-to-r from-indigo-500 to-indigo-900 text-white font-medium'>{state}
          </button>
        </form>
